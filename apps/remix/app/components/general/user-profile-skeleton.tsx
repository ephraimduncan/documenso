...
export const UserProfileSkeleton = ({ className, user, rows = 2 }: UserProfileSkeletonProps) => {
  ...
  return (
    <div
      className={cn(
        'flex flex-col items-center rounded-xl bg-muted p-4 dark:bg-background',
        className,
      )}
    >
      ...
      <div className="mt-6">
        ...
        <div className="mx-auto mt-4 h-2 w-52 rounded-full bg-muted-foreground/30" />
        <div className="mx-auto mt-2 h-2 w-36 rounded-full bg-muted-foreground/20" />
      </div>

      <div className="mt-8 w-full">
        <div className="divide-y-2 divide-border overflow-hidden rounded-lg border-2 border-border">
          <div className="bg-muted p-4 font-medium text-muted-foreground">
              ...
              >
                <div className="flex items-center gap-x-2">
                  ...
                  <div className="space-y-2">
                    <div className="h-1.5 w-24 rounded-full bg-muted-foreground/30 md:w-36" />
                    <div className="h-1.5 w-16 rounded-full bg-muted-foreground/20 md:w-24" />
                  </div>
                </div>
